...
## Learning Tools
- [AI Code Review Pipeline](https://github.com/ShannonReed-Dev/super-rider)
  > A Streamlit app that reviews code with Claude and scores its own review.


## Personal Tools
- [Stash](https://github.com/ShannonReed-Dev/stash)
  > A fully private, single-user image library.
